...
| 7 | Code health refactor | ⏳ qisman | `cmd/pkg.rs`, `cmd/migrate.rs`, `cmd/lint.rs`, `cmd/check.rs`, `cmd/fmt.rs` ✅, `builtins.rs` ✅. Only Build / Serve / Run still inline in main.rs. runner.rs / parser.rs modul ajratish — review-friendly bir nechta PR'larga bo'linishi kerak. |
