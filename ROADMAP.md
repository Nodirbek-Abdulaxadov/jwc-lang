...
| 7 | Code health refactor | ⏳ qisman | `cmd/pkg.rs`, `cmd/migrate.rs`, `cmd/lint.rs`, `cmd/check.rs`, `cmd/fmt.rs`, `cmd/build.rs` ✅, `builtins.rs` ✅. main.rs now under 500 lines; only Run / Serve handlers still inline. runner.rs / parser.rs modul ajratish — review-friendly bir nechta PR'larga bo'linishi kerak. |
