...
Asset name (release v0.4.7 as the working example):

```
jwc-v0.4.7-x86_64-unknown-linux-musl.tar.gz
jwc-v0.4.7-x86_64-unknown-linux-musl.tar.gz.sha256
```
...
```bash
curl -fLO https://github.com/Nodirbek-Abdulaxadov/jwc-lang/releases/download/v0.4.7/jwc-v0.4.7-x86_64-unknown-linux-musl.tar.gz
curl -fLO https://github.com/Nodirbek-Abdulaxadov/jwc-lang/releases/download/v0.4.7/jwc-v0.4.7-x86_64-unknown-linux-musl.tar.gz.sha256
sha256sum -c jwc-v0.4.7-x86_64-unknown-linux-musl.tar.gz.sha256
```
