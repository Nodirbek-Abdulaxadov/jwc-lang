...
pub const KEYWORDS: &[&str] = &[
    "after", "and", "as", "asc", "assert", "by", "cascade", "catch", "check",
    "class", "conflict", "cross", "database", "default", "delete", "desc",
    "do", "else", "enum", "error", "errorHandler", "except", "exists",
    "false", "first", "for", "foreign", "from", "full", "function", "group",
    "having", "identity", "if", "ilike", "import", "in", "index", "inner",
    "insert", "into", "join", "key", "left", "let", "like", "limit", "max",
    "middleware", "namespace", "no", "not", "nothing", "null", "nulls", "of",
    "on", "or", "orderby", "page", "primary", "private", "provides", "raises",
    "references", "requires", "restrict", "return", "right", "route",
    "routes", "schema", "select", "server", "service", "set", "size", "table",
    "test", "throw", "transaction", "transient", "true", "under", "unique",
    "update", "use", "using", "view", "was", "where", "with",
];
...
pub const REMOVED_KEYWORDS: &[(&str, &str)] = &[
    ...
    (
        "dome",
        "'dome' was removed in 1.0 — it has no replacement",
    ),
    (
        "dbset",
